...
// Module
___CSS_LOADER_EXPORT___.push([module.id, ":root {\n    --bg-color: #4e4e4e;\n    --bg-color-dark: #2e2e2e;\n    --bg-color-light: #7e7e7e;\n    --primary-color: #06aed5;\n    --secondary-color: #f0c808;\n    --text-color: #ecf39e;\n}\n\n* {\n    margin: 0;\n    padding: 0;\n    box-sizing: border-box;\n    font-family: 'Josefin Sans', sans-serif;\n}\n\nbody {\n    background: var(--bg-color);\n    color: var(--text-color);\n}\n#main-header {\n    background: var(--bg-color-dark);\n    margin-bottom: .25rem;\n}\n#container {\n    max-width: 40rem;\n    min-height: 75vh;\n    margin: 0 auto;\n    padding: 2rem;\n    background: var(--bg-color-dark);\n}\n\nh1, h2 {\n    color: var(--secondary-color);\n    text-align: center;\n    font-weight: 700;\n    padding: 1.25rem 0;\n}\n\nh1 {\n    font-size: 2rem;\n}\n\nh2 {\n    font-size: 1.75rem;\n}\n\np {\n    padding: .5rem 0;\n}\n\n.form {\n    width: 100%;\n    margin-top: 2rem;\n    display: block;\n}\n\n.form input {\n    width: 100%;\n    height: 2.5rem;\n    padding: .5rem;\n    font-size: 1.25rem;\n    outline: none;\n    border: none;\n    margin-bottom: 1.25rem;\n}\n\n.sendBtn{\n    background: var(--secondary-color);\n    color: var(--bg-color-dark);\n    padding: .75rem 3rem;\n    outline: none;\n    border: none;\n    font-size: 1.25rem;\n    font-weight: 700;\n    cursor: pointer;\n    transition: all 0.3s ease-in-out;\n}\n\n.sendBtn:hover, .sendBtn:focus {\n    background: transparent;\n    border: 2px solid var(--secondary-color);\n    color: var(--secondary-color);\n}\n#main-footer {\n    text-align: center;\n    font-weight: 300;\n    padding: 1.25rem;\n    margin-top: .25rem;\n    background: var(--bg-color-dark);\n}\n\n#main-footer span {\n    color: var(--primary-color);\n    font-weight: 400;\n}", "",{"version":3,"sources":["webpack://./frontend/assets/css/style.css"],"names":[],"mappings":"AAEA;IACI,mBAAmB;IACnB,wBAAwB;IACxB,yBAAyB;IACzB,wBAAwB;IACxB,0BAA0B;IAC1B,qBAAqB;AACzB;;AAEA;IACI,SAAS;IACT,UAAU;IACV,sBAAsB;IACtB,uCAAuC;AAC3C;;AAEA;IACI,2BAA2B;IAC3B,wBAAwB;AAC5B;AACA;IACI,gCAAgC;IAChC,qBAAqB;AACzB;AACA;IACI,gBAAgB;IAChB,gBAAgB;IAChB,cAAc;IACd,aAAa;IACb,gCAAgC;AACpC;;AAEA;IACI,6BAA6B;IAC7B,kBAAkB;IAClB,gBAAgB;IAChB,kBAAkB;AACtB;;AAEA;IACI,eAAe;AACnB;;AAEA;IACI,kBAAkB;AACtB;;AAEA;IACI,gBAAgB;AACpB;;AAEA;IACI,WAAW;IACX,gBAAgB;IAChB,cAAc;AAClB;;AAEA;IACI,WAAW;IACX,cAAc;IACd,cAAc;IACd,kBAAkB;IAClB,aAAa;IACb,YAAY;IACZ,sBAAsB;AAC1B;;AAEA;IACI,kCAAkC;IAClC,2BAA2B;IAC3B,oBAAoB;IACpB,aAAa;IACb,YAAY;IACZ,kBAAkB;IAClB,gBAAgB;IAChB,eAAe;IACf,gCAAgC;AACpC;;AAEA;IACI,uBAAuB;IACvB,wCAAwC;IACxC,6BAA6B;AACjC;AACA;IACI,kBAAkB;IAClB,gBAAgB;IAChB,gBAAgB;IAChB,kBAAkB;IAClB,gCAAgC;AACpC;;AAEA;IACI,2BAA2B;IAC3B,gBAAgB;AACpB","sourcesContent":["@import url('https://fonts.googleapis.com/css2?family=Josefin+Sans:wght@300;400;500;600;700&display=swap');\n\n:root {\n    --bg-color: #4e4e4e;\n    --bg-color-dark: #2e2e2e;\n    --bg-color-light: #7e7e7e;\n    --primary-color: #06aed5;\n    --secondary-color: #f0c808;\n    --text-color: #ecf39e;\n}\n\n* {\n    margin: 0;\n    padding: 0;\n    box-sizing: border-box;\n    font-family: 'Josefin Sans', sans-serif;\n}\n\nbody {\n    background: var(--bg-color);\n    color: var(--text-color);\n}\n#main-header {\n    background: var(--bg-color-dark);\n    margin-bottom: .25rem;\n}\n#container {\n    max-width: 40rem;\n    min-height: 75vh;\n    margin: 0 auto;\n    padding: 2rem;\n    background: var(--bg-color-dark);\n}\n\nh1, h2 {\n    color: var(--secondary-color);\n    text-align: center;\n    font-weight: 700;\n    padding: 1.25rem 0;\n}\n\nh1 {\n    font-size: 2rem;\n}\n\nh2 {\n    font-size: 1.75rem;\n}\n\np {\n    padding: .5rem 0;\n}\n\n.form {\n    width: 100%;\n    margin-top: 2rem;\n    display: block;\n}\n\n.form input {\n    width: 100%;\n    height: 2.5rem;\n    padding: .5rem;\n    font-size: 1.25rem;\n    outline: none;\n    border: none;\n    margin-bottom: 1.25rem;\n}\n\n.sendBtn{\n    background: var(--secondary-color);\n    color: var(--bg-color-dark);\n    padding: .75rem 3rem;\n    outline: none;\n    border: none;\n    font-size: 1.25rem;\n    font-weight: 700;\n    cursor: pointer;\n    transition: all 0.3s ease-in-out;\n}\n\n.sendBtn:hover, .sendBtn:focus {\n    background: transparent;\n    border: 2px solid var(--secondary-color);\n    color: var(--secondary-color);\n}\n#main-footer {\n    text-align: center;\n    font-weight: 300;\n    padding: 1.25rem;\n    margin-top: .25rem;\n    background: var(--bg-color-dark);\n}\n\n#main-footer span {\n    color: var(--primary-color);\n    font-weight: 400;\n}"],"sourceRoot":""}]);
// Exports
